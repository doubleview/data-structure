package leetcode_algorithm.Spiral_Matrix;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution().spiralOrder(new int[][]{{0, 1}}));
        System.out.println(new Solution().spiralOrder(new int[][]{{0, 1, 2}, {3, 4, 5}}));
