package leetcode_algorithm.N_Queens_2;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution().totalNQueens2(4));
        System.out.println(new Solution().totalNQueens(1));
        System.out.println(new Solution().totalNQueens2(1));
        System.out.println(new Solution().totalNQueens2(5));
        System.out.println(new Solution().totalNQueens2(5));
    }
